...
using Int2 = GeometryLib.Int32.D2;
...
namespace GeometryLib.Decimal.D2
{
    public struct Conversion
    {
        ...
        public static readonly decimal MaxValue = int.MaxValue - 2;

        private static readonly Int2.Vector minXMinY = new Int2.Vector(0, 0);

        private static readonly Int2.Vector minXMaxY = new Int2.Vector(0, int.MaxValue);

        private static readonly Int2.Vector maxXMinY = new Int2.Vector(int.MaxValue, 0);
        ...
        public Int2.Vector Convert(in Interfaces.D2.IVector<decimal> p)
        {
            ...
            return new Int2.Vector((int)x, (int)y);
        }
        ...
        public Vector Convert(in Int64.IIntegerPoint p)
        {
