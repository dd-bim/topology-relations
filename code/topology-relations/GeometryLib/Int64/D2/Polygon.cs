...
{
    public readonly struct Polygon : IReadOnlyList<LineString>, IGeometryOgc2<long>
    {
        ...
        internal Polygon(in ImmutableArray<LineString> rings, Int128 area2)
        {
            Rings = rings;
            Area2 = area2;
        }

        private Polygon(in IReadOnlyList<LineString> rings, Int128 area2)
        {
        ...
        public static bool Create(in IReadOnlyList<LineString> rings, out Polygon polygon)
        {
            ...
            Int128 area2 = ls.Area2;
            bool reverse = area2 < 0;
