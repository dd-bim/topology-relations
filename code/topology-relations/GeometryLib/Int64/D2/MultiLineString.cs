...
{
    public readonly struct MultiLineString : IReadOnlyList<LineString>, IGeometryOgc2<long>
    {
        ...
        private static bool TryParseWkt(in string? input, out MultiLineString lineStringCollection)
        {
            ...
            int start = input.IndexOf("MULTILINESTRING", StringComparison.InvariantCultureIgnoreCase) + 15;
