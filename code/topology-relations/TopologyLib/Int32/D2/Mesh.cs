...
namespace TopologyLib.Int32.D2
{
    public class Mesh
    {
        ...
        public static Mesh CreateTriangulation(in IReadOnlyCollection<Vector> points)
        {
            ...
            var triangle = Face.CreateTriangle(Decimal.Conversion.MinXMaxY, Decimal.Conversion.MinXMinY, sorted[0], out var vtx1, out var vtx2, out var vtx);
#if false
